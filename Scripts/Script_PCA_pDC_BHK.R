...
counts_inf_1 <- read.table("~/LocalPedago/Infecte/7006_S2_ReadsPerGene.out.tab", header = FALSE, sep = "\t")
counts_inf_2 <- read.table("~/LocalPedago/Infecte/7015_ReadsPerGene.out.tab", header = FALSE, sep = "\t")
counts_inf_3 <- read.table("~/LocalPedago/Infecte/7018_ReadsPerGene.out.tab", header = FALSE, sep = "\t")
counts_inf_4 <- read.table("~/LocalPedago/Infecte/7021_ReadsPerGene.out.tab", header = FALSE, sep = "\t")
...
counts_nonInf_1 <- read.table("~/LocalPedago/Non_Infecte/7002_ReadsPerGene.out.tab", header = FALSE, sep = "\t")
counts_nonInf_2 <- read.table("~/LocalPedago/Non_Infecte/7008_ReadsPerGene.out.tab", header = FALSE, sep = "\t")
counts_nonInf_3 <- read.table("~/LocalPedago/Non_Infecte/7012_ReadsPerGene.out.tab", header = FALSE, sep = "\t")
